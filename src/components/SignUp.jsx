  ...
  <div  className=' bg-gradient-to-r from-yellow-50 to-yellow-50 h-screen pt-24'>
   ...
   <img src="src/assets/Logo_Full Color.png" alt="logo" width="150" height="74"className="p-8 mx-auto " />
      ...
      <form onSubmit={handleSubmit}>
        ...
        className='rounded-xl w-[300px] h-[44px] p-2 my-4 mx-6 '>
        </input>
        ...
        <input type="password" 
         ...
         name="password"
          ...
          <button type="submit"
           className='bg-blue-950 text-white rounded-xl w-[300px] h-[44px] p-2 my-4 mx-6' >
            Signup 
            </button> 
        
          </form>
          <p className=' text-blue-500  my-4 mx-8 underline' >Aleardy having an account ? <Link to="/">SignIn</Link></p>
          </div>
          </div>
  )
}
